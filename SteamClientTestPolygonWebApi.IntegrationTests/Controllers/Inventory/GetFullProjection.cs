...
public class GetFullProjection : IClassFixture<InventoryWebAppFactory>
{
    private readonly InventoryWebAppFactory _factory;
    private readonly Fixture _fixture;

    public GetFullProjection(InventoryWebAppFactory factory)
    {
        _factory = factory;
    ...
    [Fact]
    public async Task GetFullProjection_ReturnsOkWithNotEmptyResult_WhenInventoryExists()
    {
        //Arrange
    ...
    [Fact]
    public async Task GetFullProjection_ReturnsNotFound_WhenInventoryNotExists()
    {
        //Arrange
        var (steam64Id, appId) = (Math.Abs(_fixture.Create<long>()), 730);
